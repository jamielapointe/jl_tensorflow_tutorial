...
def alpha_dropout(x, keep_prob, noise_shape=None, seed=None, training=False, name=None): # pylint: disable=invalid-name
  ...
  with ops.name_scope(name, "alpha_dropout", [x]) as name:
    ...
    if tensor_util.constant_value(keep_prob) == 1 or tensor_util.constant_value(training) == False:
      return x
